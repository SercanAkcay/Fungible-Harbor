...
const claimingAddress3 = leafNodes[2];
...
const hexProof3 = merkleTree.getHexProof(claimingAddress3);
console.log(hexProof3);

// ✅ - ❌: Verify is claiming address is in the merkle tree or not.
// This would be implemented in your Solidity Smart Contract
console.log(merkleTree.verify(hexProof1, claimingAddress1, rootHash));
console.log(merkleTree.verify(hexProof2, claimingAddress2, rootHash));
console.log(merkleTree.verify(hexProof3, claimingAddress3, rootHash));